...
package com.aoindustries.web.struts.clientarea.control.monitor.i18n;
...
public final class ApplicationResources extends EditableResourceBundle {
  ...
  static File getSourceFile(String filename) {
    try {
      return new File(System.getProperty("user.home") + "/maven2/ao/aoweb-struts-javaee/src/main/resources/com/aoindustries/web/struts/clientarea/control/monitor/i18n", filename);
