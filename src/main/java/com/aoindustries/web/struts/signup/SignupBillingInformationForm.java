 ...
 * Copyright (C) 2007-2009, 2016, 2017, 2018, 2021, 2022, 2025, 2026  AO Industries, Inc.
...
public class SignupBillingInformationForm extends ActionForm implements Serializable, SessionActionForm {
  ...
  public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
    ...
    if (GenericValidator.isBlankOrNull(billingCardholderName)) {
      errors.add("billingCardholderName", new ActionMessage("signupBillingInformationForm.billingCardholderName.required"));
    }
    ...
    if (GenericValidator.isBlankOrNull(billingStreetAddress)) {
      errors.add("billingStreetAddress", new ActionMessage("signupBillingInformationForm.billingStreetAddress.required"));
    }
