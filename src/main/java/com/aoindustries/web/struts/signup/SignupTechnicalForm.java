 ...
 * Copyright (C) 2007-2009, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2025, 2026  AO Industries, Inc.
      ...
      if (GenericValidator.isBlankOrNull(baUsername)) {
        ...
        if (myServlet != null) {
          ...
          if (!check.isValid()) {
            ...
            if (!rootConn.getAccount().getUser().isUsernameAvailable(userId)) {
              errors.add("baUsername", new ActionMessage("signupTechnicalForm.baUsername.unavailable"));
            }
          }
        }
      }
