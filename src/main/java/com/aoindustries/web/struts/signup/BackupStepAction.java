 ...
 */
public abstract class BackupStepAction extends PageAction {
	...
	public final ActionForward execute(
		...
		BackupSignupSelectPackageForm signupSelectPackageForm = SignupHelper.getSessionActionForm(servlet, session, BackupSignupSelectPackageForm.SESSION_ATTRIBUTE, BackupSignupSelectPackageForm::new);
