 ...
 * Copyright (C) 2009-2013, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2025, 2026  AO Industries, Inc.
...
public final class MinimalConfirmationCompletedActionHelper {
  ...
  public static void sendSupportSummaryEmail(
    ...
    try {
      ...
      sendSummaryEmail(servlet, pkey, statusKey, siteSettings.getBrand().getAowebStrutsSignupAdminAddress(),
          packageDefinition, signupOrganizationForm, signupTechnicalForm, signupBillingInformationForm);
