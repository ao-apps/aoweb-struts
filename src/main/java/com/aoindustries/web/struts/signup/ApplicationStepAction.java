 ...
 * Copyright (C) 2009, 2015, 2016, 2019, 2021, 2022, 2025, 2026  AO Industries, Inc.
 ...
 */
public abstract class ApplicationStepAction extends PageAction {
  ...
  public final ActionForward execute(
    ...
    ApplicationSignupSelectPackageForm signupSelectPackageForm = SignupHelper.getSessionActionForm(
        servlet, session, ApplicationSignupSelectPackageForm.SESSION_ATTRIBUTE, ApplicationSignupSelectPackageForm::new);
