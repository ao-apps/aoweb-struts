 ...
 * Copyright (C) 2007-2009, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2024, 2025, 2026  AO Industries, Inc.
 ...
 *
 * <p>TODO: 303 redirect after all payment (and attempts).  A client double-paid with an accidental refresh.</p>
 *
...
public class MakePaymentNewCardCompletedAction extends MakePaymentNewCardAction {
  ...
  public final ActionForward execute(
    ...
    if (rootAoProcessor == null) {
      throw new SQLException("Unable to find CreditCardProcessor: " + rootProcessor.getProviderId());
    }
  ...
  private void setAutomatic(AoservConnector rootConn, com.aoapps.payments.CreditCard newCreditCard, Account account) throws SQLException, IOException {
    ...
    if (!creditCard.getAccount().equals(account)) {
      throw new SQLException("Requested account and CreditCard account do not match: " + creditCard.getAccount_name() + " != " + account.getName());
    }
