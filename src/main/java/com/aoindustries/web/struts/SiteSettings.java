 ...
 * Copyright (C) 2009-2013, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2024, 2025, 2026  AO Industries, Inc.
...
public class SiteSettings {
  ...
  public List<Skin.Language> getLanguages(ServletRequest req) throws IOException, SQLException {
    ...
    if (locale == null) {
      // Can't use: LocaleFilter.getDefaultLocale(req); due to stack overflow
