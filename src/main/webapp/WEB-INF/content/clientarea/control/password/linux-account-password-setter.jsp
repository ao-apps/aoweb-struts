			...
			<skin:contentLine>
				...
				<logic:notPresent scope="request" name="permissionDenied">
					<logic:empty scope="request" name="linuxAccountPasswordSetterForm" property="packages">
						<b><ao:message key="linuxAccountPasswordSetter.noAccounts" /></b>
					</logic:empty>
						...
						<html:form action="/password/linux-account-password-setter-completed">
							<skin:lightArea>
								<table class="ao-no-border">
									<thead>
										<tr>
											...
											<logic:greaterThan name="packagesSize" value="1">
												<th><ao:message key="linuxAccountPasswordSetter.header.package" /></th>
											</logic:greaterThan>
											<th><ao:message key="linuxAccountPasswordSetter.header.username" /></th>
											<bean:size scope="request" name="aoConn" property="linux.Server.map" id="serversSize" />
											<logic:greaterThan name="serversSize" value="1">
												<th><ao:message key="linuxAccountPasswordSetter.header.server" /></th>
											</logic:greaterThan>
											<th colspan='2'><ao:message key="linuxAccountPasswordSetter.header.newPassword" /></th>
											<th><ao:message key="linuxAccountPasswordSetter.header.confirmPassword" /></th>
											<th>&#160;</th>
										</tr>
									</thead>
									<tbody>
									...
									<tfoot>
										<tr><td colspan="7" style="text-align:center"><ao:input type="submit" value="${ao:message('linuxAccountPasswordSetter.field.submit.label')}" /></td></tr>
									</tfoot>
								</table>
							</skin:lightArea>
						</html:form>
