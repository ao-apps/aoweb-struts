    ...
    <skin:lightArea>
         <table cellpadding="0" cellspacing="0">
            ...
            <tr valign='top'>
                ...
                <td style="white-space:nowrap"><html:checkbox property="billingUseMonthly" /><bean:message bundle="/signup/ApplicationResources" key="signupBillingInformationForm.billingUseMonthly.value" /><br /><br /></td>
