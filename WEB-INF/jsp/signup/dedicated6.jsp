                ...
                <form action="dedicated6Completed.do" method="POST">
                    <skin:lightArea>
                         <TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
                            <TR><TD COLSPAN="3"><B><bean:message bundle="/signup/ApplicationResources" key="dedicated6.stepLabel"/></B><BR><HR></TD></TR>
                            <TR><TD COLSPAN="3"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.stepHelp"/></TD></TR>
                                ...
                                <TH colspan="3">
                                    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <TR>
                                            ...
                                            <TD align='right'><html:link styleClass="ao_light_link" action="/dedicated"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.edit.link"/></html:link></TD>
                                        </TR>
                                    </TABLE>
                                </TH>
                            </TR>
                                ...
                                <TH colspan="3">
                                    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <TR>
                                            ...
                                            <TD align='right'><html:link styleClass="ao_light_link" action="/dedicated2"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.edit.link"/></html:link></TD>
                                        </TR>
                                    </TABLE>
                                </TH>
                            </TR>
                                ...
                                <TH colspan="3">
                                    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <TR>
                                            ...
                                            <TD align='right'><html:link styleClass="ao_light_link" action="/dedicated3"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.edit.link"/></html:link></TD>
                                        </TR>
                                    </TABLE>
                                </TH>
                            </TR>
                                ...
                                <TH colspan="3">
                                    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <TR>
                                            ...
                                            <TD align='right'><html:link styleClass="ao_light_link" action="/dedicated4"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.edit.link"/></html:link></TD>
                                        </TR>
                                    </TABLE>
                                </TH>
                            </TR>
                                ...
                                <TH colspan="3">
                                    <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <TR>
                                            ...
                                            <TD align='right'><html:link styleClass="ao_light_link" action="/dedicated5"><bean:message bundle="/signup/ApplicationResources" key="dedicated6.edit.link"/></html:link></TD>
                                        </TR>
                                    </TABLE>
                                </TH>
                            </TR>
                            ...
                            <TR><TD colspan="3" align="center"><br><html:submit styleClass='ao_button'><bean:message bundle="/signup/ApplicationResources" key="dedicated6.submit.label"/></html:submit><br><br></td></tr>
                        </TABLE>
                    </skin:lightArea>
                </form>
            </skin:contentLine>
