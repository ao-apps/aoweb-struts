        ...
        <logic:notEmpty scope="request" name="permissionDenied">
            ...
            <logic:equal name="permissionDeniedSize" value="1">
                ...
                <logic:iterate scope="request" name="permissionDenied" id="andPermission" type="com.aoindustries.aoserv.client.AOServPermission">
                    <bean:define name="andPermission" property="displayKey" id="permissionDisplayKey" type="java.lang.String"/>
                    <bean:define name="andPermission" property="descriptionKey" id="permissionDescriptionKey" type="java.lang.String"/>
                    <p>
                        <table border='0' cellspacing='0' cellpadding='2'>
                            <tr>
                                <td><b><bean:message bundle="/ApplicationResources" key="permissionDenied.permission.display"/></b></td>
                                <td><bean:message bundle="/aoserv/client/ApplicationResources" key="<%= permissionDisplayKey %>"/></td>
                            </tr>
                            <tr>
                                <td><b><bean:message bundle="/ApplicationResources" key="permissionDenied.permission.description"/></b></td>
                                <td><bean:message bundle="/aoserv/client/ApplicationResources" key="<%= permissionDescriptionKey %>"/></td>
                            </tr>
                        </table>
                    </p>
                </logic:iterate>
            ...
            <logic:notEqual name="permissionDeniedSize" value="1">
                ...
                <p>
                    <table border='0' cellspacing='0' cellpadding='2'>
                        ...
                        <logic:iterate scope="request" name="permissionDenied" id="andPermission" type="com.aoindustries.aoserv.client.AOServPermission">
                            <bean:define name="andPermission" property="displayKey" id="andPermissionDisplayKey" type="java.lang.String"/>
                            <bean:define name="andPermission" property="descriptionKey" id="andPermissionDescriptionKey" type="java.lang.String"/>
                            <tr>
                                <td nowrap><bean:message bundle="/aoserv/client/ApplicationResources" key="<%= andPermissionDisplayKey %>"/></td>
                                <td nowrap><bean:message bundle="/aoserv/client/ApplicationResources" key="<%= andPermissionDescriptionKey %>"/></td>
                                <td nowrap>
