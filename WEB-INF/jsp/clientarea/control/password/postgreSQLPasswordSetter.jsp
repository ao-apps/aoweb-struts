...
<skin:setContentType/>
<html:html lang="true">
    <skin:path>/clientarea/control/password/postgreSQLPasswordSetter.do</skin:path>
            ...
            <skin:contentLine>
                ...
                <logic:notPresent scope="request" name="permissionDenied">
                    ...
                    <logic:notEmpty scope="request" name="postgreSQLPasswordSetterForm" property="packages">
                        <html:form action="/password/postgreSQLPasswordSetterCompleted">
                            <skin:lightArea>
                                <TABLE cellspacing='0' cellpadding='2' border='0'>
                                    ...
                                    <TR><TD colspan='8' align='center'><html:submit styleClass='ao_button'><bean:message bundle="/clientarea/control/ApplicationResources" key="password.postgreSQLPasswordSetter.field.submit.label"/></html:submit></TD></TR>
                                </TABLE>
                            </skin:lightArea>
                        </html:form>
                    </logic:notEmpty>
