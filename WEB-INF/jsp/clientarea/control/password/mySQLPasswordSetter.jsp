...
<skin:setContentType/>
<html:html lang="true">
    <skin:path>/clientarea/control/password/mySQLPasswordSetter.do</skin:path>
            ...
            <skin:contentLine>
                ...
                <logic:notPresent scope="request" name="permissionDenied">
                    ...
                    <logic:notEmpty scope="request" name="mySQLPasswordSetterForm" property="packages">
                        <html:form action="/password/mySQLPasswordSetterCompleted">
                            <skin:lightArea>
                                <TABLE cellspacing='0' cellpadding='2' border='0'>
                                    ...
                                    <logic:iterate scope="request" name="mySQLPasswordSetterForm" property="packages" id="pack" indexId="index">
                                        <TR>
                                            ...
                                            <logic:greaterThan name="mysqlServersSize" value="1">
                                                <TD><CODE><bean:write name="mySQLPasswordSetterForm" property='<%= "mySQLServers[" + index + "]" %>' filter="true"/></CODE></TD>
                                            </logic:greaterThan>
                                            <html:hidden property='<%= "aoServers[" + index + "]" %>'/>
                                            <logic:greaterThan name="aoServersSize" value="1">
                                                <TD><CODE><bean:write name="mySQLPasswordSetterForm" property='<%= "aoServers[" + index + "]" %>' filter="true"/></CODE></TD>
                                            </logic:greaterThan>
                                    ...
                                    <TR><TD colspan='8' align='center'><html:submit styleClass='ao_button'><bean:message bundle="/clientarea/control/ApplicationResources" key="password.mySQLPasswordSetter.field.submit.label"/></html:submit></TD></TR>
                                </TABLE>
                            </skin:lightArea>
                        </html:form>
                    </logic:notEmpty>
