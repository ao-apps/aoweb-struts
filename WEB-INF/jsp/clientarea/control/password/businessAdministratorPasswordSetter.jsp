...
<skin:setContentType/>
<html:html lang="true">
    <skin:path>/clientarea/control/password/businessAdministratorPasswordSetter.do</skin:path>
        ...
        <skin:content width="600">
            ...
            <skin:contentLine>
                ...
                <logic:notEmpty scope="request" name="businessAdministratorPasswordSetterForm" property="packages">
                    <html:form action="/password/businessAdministratorPasswordSetterCompleted">
                        <skin:lightArea>
