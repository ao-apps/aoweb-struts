...
<skin:setContentType/>
<html:html lang="true">
    <skin:path>/clientarea/control/password/linuxAccountPasswordSetter.do</skin:path>
            ...
            <skin:contentLine>
                ...
                <logic:notPresent scope="request" name="permissionDenied">
                    ...
                    <logic:notEmpty scope="request" name="linuxAccountPasswordSetterForm" property="packages">
                        <html:form action="/password/linuxAccountPasswordSetterCompleted">
                            <skin:lightArea>
                                <TABLE cellspacing='0' cellpadding='2' border='0'>
                                    ...
                                    <TR><TD colspan='7' align='center'><html:submit styleClass='ao_button'><bean:message bundle="/clientarea/control/ApplicationResources" key="password.linuxAccountPasswordSetter.field.submit.label"/></html:submit></TD></TR>
                                </TABLE>
                            </skin:lightArea>
                        </html:form>
                    </logic:notEmpty>
