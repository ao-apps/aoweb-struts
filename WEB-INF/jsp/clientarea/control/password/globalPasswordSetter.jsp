...
<skin:setContentType/>
<html:html lang="true">
    <skin:path>/clientarea/control/password/globalPasswordSetter.do</skin:path>
            ...
            <skin:contentLine>
                ...
                <logic:notPresent scope="request" name="permissionDenied">
                    ...
                    <logic:notEmpty scope="request" name="globalPasswordSetterForm" property="packages">
                        <html:form action="/password/globalPasswordSetterCompleted">
                            <skin:lightArea>
                                <TABLE cellspacing='0' cellpadding='2' border='0'>
                                    ...
                                    <TR><TD colspan='6' align='center'><html:submit styleClass='ao_button'><bean:message bundle="/clientarea/control/ApplicationResources" key="password.globalPasswordSetter.field.submit.label"/></html:submit></TD></TR>
                                </TABLE>
                            </skin:lightArea>
                        </html:form>
                    </logic:notEmpty>
