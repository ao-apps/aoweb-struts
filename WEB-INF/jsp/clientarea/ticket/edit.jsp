                    ...
                    <html:form action="/edit-completed" onsubmit="return validateTicketForm(this);">
                        <skin:lightArea>
                            <table border="0" cellspacing="0" cellpadding="4">
                                <tr>
                                    <td nowrap><bean:message bundle="/clientarea/ticket/ApplicationResources" key="edit.label.pkey"/></td>
                                    <td><html:hidden name="ticket" property="pkey" write="true"/></td>
                                </tr>
                                <tr>
                                    <td nowrap><bean:message bundle="/clientarea/ticket/ApplicationResources" key="edit.label.status"/></td>
                                    <td>
                                ...
                                <tr>
                                    <td nowrap><bean:message bundle="/clientarea/ticket/ApplicationResources" key="edit.label.openDate"/></td>
                                ...
                                <logic:notEmpty scope="request" name="ticket" property="createdBy">
                                    <tr>
                                        <td nowrap><bean:message bundle="/clientarea/ticket/ApplicationResources" key="edit.label.createdBy"/></td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="4">
                                    ...
                                    <logic:iterate name="actions" type="com.aoindustries.aoserv.client.TicketAction" id="action">
                                        <skin:lightDarkTableRow pageAttributeId="isDark">
                                            <td nowrap><aoweb:dateTime><bean:write name="action" property="time"/></aoweb:dateTime></td>
                                            <td nowrap>
                                                <logic:present name="action" property="administrator">
                                                    <bean:write name="action" property="administrator.name"/>
                                                </logic:present>
                                            </td>
                                            <td nowrap><bean:write name="action" property="ticketActionType"/></td>
                                            <td nowrap>
                                                <bean:define scope="request" name="locale" type="java.util.Locale" id="locale"/>
                        ...
                        <skin:lightArea>
                            ...
                            <table border="0" cellspacing="0" cellpadding="4">
                                <tr>
                                    <td nowrap><bean:message bundle="/clientarea/ticket/ApplicationResources" key="TicketForm.field.annotationSummary.prompt"/></td>
