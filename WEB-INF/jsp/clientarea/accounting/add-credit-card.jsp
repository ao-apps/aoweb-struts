                        ...
                        <html:form action="/add-credit-card-completed">
                            <skin:lightArea>
                                ...
                                <table border="0" cellspacing="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCard.required.yes"/></td>
                                    ...
                                    <tr>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCard.required.no"/></td>
                                    ...
                                    <tr>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCard.required.yes"/></td>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCardForm.cardNumber.prompt"/></td>
                                    ...
                                    <tr>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCard.required.yes"/></td>
                                        <td nowrap><bean:message bundle="/clientarea/accounting/ApplicationResources" key="addCreditCardForm.expirationDate.prompt"/></TD>
                                        <td nowrap>
                                    ...
                                    <tr>
                                        ...
                                        <td nowrap>
                                            <html:select property="countryCode">
                                                ...
                                                <bean:define name="addCreditCardForm" property="countryCode" id="country" type="java.lang.String"/>
