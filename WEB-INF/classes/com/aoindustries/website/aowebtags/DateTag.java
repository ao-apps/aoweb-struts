    ...
    public int doEndTag() throws JspException {
        try {
            ...
            if(scriptGroupTag!=null) {
                ChainWriter.writeDateJavaScript(millis, sequence, pageContext.getOut(), scriptGroupTag.getScriptOut());
            } else {
                StringBuilder scriptOut = new StringBuilder();
                ChainWriter.writeDateJavaScript(millis, sequence, pageContext.getOut(), scriptOut);
