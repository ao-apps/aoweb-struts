 ...
 */
public class DedicatedSignupCustomizeServerForm extends ActionForm implements Serializable {
    ...
    public DedicatedSignupCustomizeServerForm() {
        setPowerOption(-1);
        setCpuOption(-1);
        setRamOption(-1);
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        try {
            ...
            if(rootConn!=null) {
                DedicatedSignupSelectServerForm dedicatedSignupSelectServerForm = (DedicatedSignupSelectServerForm)request.getSession().getAttribute("dedicatedSignupSelectServerForm");
                if(dedicatedSignupSelectServerForm!=null) {
                    pd = rootConn.packageDefinitions.get(dedicatedSignupSelectServerForm.getPackageDefinition());
                }
            }
            ...
            if(powerOption==-1 && limits!=null) {
                ...
                if(found) errors.add("powerOption", new ActionMessage("dedicatedSignupCustomizeServerForm.powerOption.required"));
            }
            if(cpuOption==-1) errors.add("cpuOption", new ActionMessage("dedicatedSignupCustomizeServerForm.cpuOption.required"));
            if(ramOption==-1) errors.add("ramOption", new ActionMessage("dedicatedSignupCustomizeServerForm.ramOption.required"));
            if(sataControllerOption==-1 && limits!=null) {
                ...
                if(found) errors.add("sataControllerOption", new ActionMessage("dedicatedSignupCustomizeServerForm.sataControllerOption.required"));
            }
            if(scsiControllerOption==-1 && limits!=null) {
                ...
                if(found) errors.add("scsiControllerOption", new ActionMessage("dedicatedSignupCustomizeServerForm.scsiControllerOption.required"));
            }
            ...
            if(!foundDisk) {
                ...
                if(!foundDisk) {
                    ...
                    if(!foundDisk) {
                        if(!ideOptions.isEmpty()) errors.add("ideOptions", new ActionMessage("dedicatedSignupCustomizeServerForm.atLeastOneDisk"));
                        else if(!sataOptions.isEmpty()) errors.add("sataOptions", new ActionMessage("dedicatedSignupCustomizeServerForm.atLeastOneDisk"));
                        else if(!scsiOptions.isEmpty()) errors.add("scsiOptions", new ActionMessage("dedicatedSignupCustomizeServerForm.atLeastOneDisk"));
                    }
                }
            }
            return errors;
