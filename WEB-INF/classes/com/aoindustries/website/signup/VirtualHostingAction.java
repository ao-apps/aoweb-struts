...
public class VirtualHostingAction extends VirtualHostingStepAction {
    ...
    public ActionForward executeVirtualHostingStep(
        ...
        List<PackageDefinition> packageDefinitions = SignupSelectPackageActionHelper.getPackageDefinitions(getServlet().getServletContext(), PackageCategory.VIRTUAL, response.getLocale());
