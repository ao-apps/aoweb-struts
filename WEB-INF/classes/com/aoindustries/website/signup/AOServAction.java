...
public class AOServAction extends AOServStepAction {
    ...
    public ActionForward executeAOServStep(
        ...
        List<PackageDefinition> packageDefinitions = SignupSelectPackageActionHelper.getPackageDefinitions(getServlet().getServletContext(), PackageCategory.AOSERV, response.getLocale());
