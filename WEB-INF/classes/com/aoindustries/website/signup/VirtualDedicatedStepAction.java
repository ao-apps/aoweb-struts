...
abstract public class VirtualDedicatedStepAction extends HttpsAction {
    ...
    final public ActionForward executeProtocolAccepted(
        ...
        if(selectedStep!=null && (selectedStep=selectedStep.trim()).length()>0) {
            if(
                "virtualDedicated".equals(selectedStep)
                || "virtualDedicated2".equals(selectedStep)
                || "virtualDedicated3".equals(selectedStep)
                || "virtualDedicated4".equals(selectedStep)
                || "virtualDedicated5".equals(selectedStep)
                || "virtualDedicated6".equals(selectedStep)
            ) {
        ...
        SignupSelectServerForm signupSelectServerForm = (SignupSelectServerForm)session.getAttribute("virtualDedicatedSignupSelectServerForm");
        SignupCustomizeServerForm signupCustomizeServerForm = (SignupCustomizeServerForm)session.getAttribute("virtualDedicatedSignupCustomizeServerForm");
