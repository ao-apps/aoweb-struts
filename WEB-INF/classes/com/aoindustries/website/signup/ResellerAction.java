...
public class ResellerAction extends ResellerStepAction {
    ...
    public ActionForward executeResellerStep(
        ...
        List<PackageDefinition> packageDefinitions = SignupSelectPackageActionHelper.getPackageDefinitions(getServlet().getServletContext(), PackageCategory.RESELLER, response.getLocale());
